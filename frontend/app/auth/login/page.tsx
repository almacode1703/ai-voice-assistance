...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-white relative overflow-hidden flex items-center justify-center px-4 py-12">
      ...
      <motion.div
        className="absolute -top-32 -right-32 w-[500px] h-[500px] rounded-full bg-cyan-400/20 blur-[80px]"
        animate={{ scale: [1, 1.15, 1], opacity: [0.2, 0.35, 0.2] }}
        transition={{ duration: 7, repeat: Infinity, ease: "easeInOut" }}
      />
      <motion.div
        className="absolute -bottom-32 -left-32 w-[450px] h-[450px] rounded-full bg-violet-400/20 blur-[80px]"
        animate={{ scale: [1.1, 1, 1.1], opacity: [0.2, 0.35, 0.2] }}
        transition={{ duration: 6, repeat: Infinity, ease: "easeInOut" }}
      />
      <motion.div
        className="absolute top-[45%] left-[40%] w-[350px] h-[350px] rounded-full bg-pink-400/15 blur-[70px]"
      ...
      >
        <div className="bg-white border border-slate-200/80 shadow-[0_24px_64px_rgba(0,0,0,0.07)] rounded-2xl overflow-hidden">
          {/* Gradient accent bar */}
