  ...
  return (
    <div className="min-h-screen flex overflow-hidden">
      ...
      >
        {/* Subtle ambient orbs */}
        <motion.div
          className="absolute -top-28 -right-28 w-[360px] h-[360px] rounded-full bg-cyan-400/10 blur-[80px] pointer-events-none"
          animate={{ scale: [1, 1.12, 1], opacity: [0.08, 0.18, 0.08] }}
          transition={{ duration: 8, repeat: Infinity, ease: "easeInOut" }}
        />
        <motion.div
          className="absolute -bottom-24 -left-24 w-[320px] h-[320px] rounded-full bg-violet-400/10 blur-[70px] pointer-events-none"
        ...
        >
          <div
            ...
            style={{ background: "linear-gradient(160deg, rgba(255,255,255,0.97) 0%, rgba(238,242,255,0.93) 100%)" }}
          >
            {/* Gradient accent bar */}
            <div className="h-1.5 bg-gradient-to-r from-cyan-500 via-violet-500 to-pink-500" />
            ...
            <div className="p-8">
              ...
              <div className="mb-6">
                ...
                <p className="text-slate-500 text-sm mt-1">Sign in to access your AI assistant</p>
              </div>
              ...
              <div className="relative mb-6">
                ...
                <div className="relative flex justify-center text-xs">
                  <span className="px-3 text-slate-400 font-medium" style={{ backgroundColor: "rgba(238,242,255,0.95)" }}>or continue with email</span>
                </div>
              </div>
              ...
              <form onSubmit={handleCredentials} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 bg-slate-50 border-2 border-slate-200 rounded-xl text-slate-900 placeholder-slate-400 text-sm focus:outline-none focus:border-cyan-400 focus:bg-white transition-all duration-200"
                  />
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      placeholder="••••••••"
                      required
                      className="w-full px-4 py-3 pr-12 bg-slate-50 border-2 border-slate-200 rounded-xl text-slate-900 placeholder-slate-400 text-sm focus:outline-none focus:border-cyan-400 focus:bg-white transition-all duration-200"
                    />
                    <button
                      type="button"
                ...
                <motion.button
                  type="submit"
                  disabled={loading}
                  className="w-full relative overflow-hidden py-3.5 rounded-xl text-sm font-bold text-white shadow-lg cursor-pointer disabled:opacity-70 disabled:cursor-not-allowed"
              ...
              <p className="text-center text-xs text-slate-400 mt-6">
                ...
                <Link href="/auth/register" className="text-violet-600 font-semibold hover:text-violet-700 transition-colors">
                  Create one free
                </Link>
              </p>
            </div>
          ...
          >
            {["24/7 AI", "Voice & Chat", "Free to use"].map((item) => (
